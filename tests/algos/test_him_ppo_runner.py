...
def test_him_iteration_progress_is_one_equivalent_multiline_log_record(
    ...
    with caplog.at_level(logging.INFO, logger="legged_manipulation_unilab.algos.him_ppo.runner"):
        runner._log_iter(
            it=1,
            tot=3,
            value_loss=0.25,
    ...
    records = [
        ...
        if record.name == "legged_manipulation_unilab.algos.him_ppo.runner"
    ]
