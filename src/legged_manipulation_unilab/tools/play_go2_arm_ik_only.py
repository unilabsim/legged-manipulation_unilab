...
from legged_manipulation_unilab.tasks.go2_arm.base import build_go2_arm_position_gains
from legged_manipulation_unilab.tasks.go2_arm.manip_loco import Go2ArmManipLocoCfg
...
def _load_model(args: argparse.Namespace) -> tuple[mujoco.MjModel, Go2ArmManipLocoCfg]:
    ...
    source = Path(resolve_scene(getattr(args, "model_file", None) or cfg.model_file))
